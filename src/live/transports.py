...
from .request_mode_adapter import (
    ...
    extract_openai_message_content as _extract_openai_message_content,
    extract_openai_tool_calls as _extract_openai_tool_calls,
    extract_text_response as _extract_text_response,
    extract_text_tool_calls as _extract_text_tool_calls,
    fallback_tool_calls_for_user_text as _fallback_tool_calls_for_user_text,
    is_text_thought_only as _is_text_thought_only,
    normalize_function_call_args as _normalize_function_call_args,
)
